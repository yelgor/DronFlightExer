...
Проєкт розділений на окремі модулі. Керування, телеметрія, MAVLink-команди, PID-регулятори, логування та графік не змішані в одному файлі, бо навіть Python не повинен перетворюватися на склад випадкових функцій.
